...
days (\textbf{C4} and \textbf{D4}). This comparison illustrates the model's ability to reproduce the observed temperatures at each measurement point accurately, contrasting the non-assimilated cases (\textbf{C} and \textbf{D}) with the partially and fully assimilated ones (\textbf{C1-4} and \textbf{D1-4}). \kcomment{Not sure what the implication
  of ``point-wise behavior'' means. Also is it not 'no assimilation'
  and 'assimilation' rather than minimum/maximum which don't have a
  meaning here?}. \rmcomment{corrected}
%This comparison highlights how well the statistical model reproduces the observed temperatures at each measurement point, contrasting the non-assimilated cases (C and D) with the fully assimilated ones (C4 and D4)
