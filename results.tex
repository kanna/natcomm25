...
Following the overview of the surface conditions, Figure
\ref{fig:temperatureprofiles} presents the vertical temperature
...
hours each day. However, as Figure \ref{fig:temperatureprofiles}
...
\begin{figure}
  \centering \subfigure[Sea surface temperature (SST) and XP2, XP3 and
  XP5 trajectories during the FRESNEL field campaign (29–31
  October).]{\label{fig:sst}\includegraphics[width=1\linewidth]{fig/SST_L3_color1.pdf}}
