...
\begin{figure}[!t]
  ...
  and its environment.]{\label{fig:domain}\includegraphics[scale=0.457]{fig/area_ripples.png}}
  \caption{\subref{fig:po-map} \& \subref{fig:domain} show detailed
    ...
    \rone{along with other prominent features.}}
...
rich \rone{physical-–biogeochemical} interactions makes the \naz
Canyon region an ideal natural laboratory to test sampling strategies
...
\rone{\sout{\proj itself is part of a larger concept for multi-domain
    ...
    democratize ocean model prediction by integrating methods with
    spatio-temporal data assimilation from mobile or immobile robots
    across space, aerial, surface and underwater domains
    \cite{rajan21}.}}
