...
Figures \ref{fig:rms_c} and \ref{fig:rms_c}  presents the root-mean-square error (RMSE) of temperature predictions compared with in-situ data from LAUVs XP2, XP3, and XP5 under the different assimilation scenarios (C, C4, D, and D4) for 31st October. The results are shown as a function of depth and vehicle, allowing a direct comparison between simulations with and without data assimilation. I SUGGEST EXPLAINING THIS BETTER
