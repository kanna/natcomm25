...
\begin{wrapfigure}{!h}{2.75in}
 ...
 \includegraphics[scale=0.2]{fig/data_cycle.png}
  \caption{\proj attempts to close the
    ...
    prediction which in turn WILL BE USED TO INFORM THE SAMPLING STRATEGY OF THE robotic vehicles to REDUCE model uncertainty.}
  \label{fig:loop-closure} SUGGEST ELIMINATING THE WORK ALGORITHM FROM THE FIGURE
\end{wrapfigure}


Implementing such a system IT IS NOT CLEAR WHAT SYSTEM ARE WE TALKING ABOUT in the dynamic real world of the coastal
