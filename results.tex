...
model’s predictive performance across all tested scenarios. Figures
\ref{fig:rms_ABB1}, \ref{fig:rms_c}, and \ref{fig:rms_d}
...
The first set of results, summarized in Figure \ref{fig:rms_ABB1},
...
\begin{figure}[!]
  \centering
1  \includegraphics[scale=0.4]{fig/rms_ABB1.png}
...
\begin{figure}
  ...
  \subfigure[RMSE (in $^{\circ}$C) between statistical model forecasts and
