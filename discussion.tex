...
\rmcomment{we can talk here about the clustering/ allocation by areas
  ...
  future studies YES.} \kcomment{Agree. This is where you might
  speculate on how to separate out the regions using PCA or some form
  of clustering but with a clear intended application.}
...
acquired as the vehicles navigated through each
cell.\kcomment{Fig. \ref{fig:iqd_3D} is very hard to read. Equally,
  might not there be the argument, that to overcome this variability,
  perhaps a higher res. model should be used? So it might be
  worthwhile to make a stronger case for this statistical modeling
  approach in the methods section. See my comments there.}
...
remained stationary to communicate and acquire GPS. % As such, these
% maxima likely reflect oversampling at specific locations rather than
% representative variability across the full domain.
