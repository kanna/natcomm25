...
XP5)\footnote{We will refer to these specific vehicles across the
  three day period given the diversity ans specificity of their
...
Canyon region, with all vehicles sampling the upper 100 m of the water
...
% \begin{figure}
%   \centering
%   \includegraphics[scale=0.35]{fig/scheme.png}
%   \caption{Three-day sequence
%     (29\textsuperscript{th}–-31\textsuperscript{st} October 2025) of
%     the \emph{sample-–assimilate–-predict-–direct} loop in the \proj
%     experiment. Each cycle integrated CMS derived statistical model
...
provides a compact, colour-coded overview of all configurations,
including forecast dates, prior CMS fields, and the specific AUV
datasets assimilated at each stage.
...
30\textsuperscript{st} October (\textbf{C4}).
