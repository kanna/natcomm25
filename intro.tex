...
the novelty of our work is in demonstrating the applicability using
propelled AUVs which can control its trajectory using onboard
...
feedback loop between data acquistion, models and observations; model
...
uncertainty. Data assimilation from these high uncertainty regions are
