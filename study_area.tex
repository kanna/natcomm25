...
\begin{figure}[!t]
  ...
  the placement of
  buoys.]{\label{fig:domain}\includegraphics[scale=0.19]{fig/area_ripples.png}}
...
Implementing such a closed-loop system in the dynamic real world of
the coastal region presents substantial challenges requiring
 high-resolution numerical models capable of rapidly generating
...
updates, and assimilation frameworks able to integrate heterogeneous,
real-time data streams. Furthermore, the logistical risks and
communication limitations inherent in marine operations — low
