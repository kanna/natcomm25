...
longer lead time to prediction given the challenges of computability
on such mode. Our ultimate direction is in encapsulating a model
surrogate embedded within the control system of one or more AUVs to
capture coastal dynamism at fine scales \cite{frolov09,fossum19b},
