...
model predictions with adaptive sampling with propelled AUVs. \rone{
  ...
  control their trajectory using onboard computation and articulating
  the importance of the larger \emph{sample-assimilate-predict-direct}
  loop. Our setup is also simpler with CMEMS seeding the stochastic
  model augmenting while using a low-cost operational approach with
  small boats, the use of multiple AUVs all the while relying on our
  mature technology suite for command/control of vehicles.}
