...
Chellenging meteorological and ocean conditions constrained the team
...
setting. AUV CTDs used for this effort, were cross-calibrated at the
initiation of the experiment. While the AUVs had a range of sensors,
the model's workflow was focused only towards temperature data; we
believe that results in Sec \ref{sec:results} are general enough to
apply to other critical oceanographic variables which can be modeled
similarly.
