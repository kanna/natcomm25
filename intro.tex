...
The coastal ocean, the marine areaS extending from the coastline to the
...
redistributed and affect marine ecosystems. SHALL WE INCLUDE A REFERENCE TO THE URBAN SEA BY DELANEY. IT EMPHASIZES THE NEED FOR WHAT WE DO
...
risks such as VESSEL TRAFFIC, high currents and bathymetry, IN ADDITION, the ocean itself
...
skills % This work focuses on the underlying problem: how to
% effectively close the loop between model predictions, observational
% targeting, and data assimilation
...
adaptive ocean exploration. FURTHERMORE, WE DEMONSTRATE THAT THIS SAMPLING ROBOTIC SYSTEM OFFERS UNPRECEDENTED CAPABILITIES FOR OCEAN STUDIES BY PROVIDING SAMPLES IN CLOSE TO REAL-TIME AND ENABLING SCIENTISTS TO RETASK WITHIN MINUTES IF SOME INTERESTING FEATURE IS DETECTED.
