...
\cite{soares2001direct}\footnote{Defined by kriging estimates and
  ...
  a spatial covariance matrix.\kcomment{Citation would be good here}},
where each simulated value is drawn from its conditional distribution,
accounting for both prior simulated values and local mean
models. Doing so enables consistent updating of the variable field
while integrating both direct AUV observations and a priori
information. The ensemble of realizations thus provides an updated
ocean forecast and a quantitative measure of uncertainty.
