\def\rm#1{\begin{itemize}\item[RM$\Rightarrow$]\textsf{#1}\end{itemize}}
...
\newcommand{\rone}[1]{{\color{blue}{\{R1: #1\}}}}
\newcommand{\rtwo}[1]{{\color{red}{\{R2: #1\}}}}
\newcommand{\kcomment}[1]{{\color{magenta}{\{KR: #1\}}}}
\newcommand{\kc}{\kcomment}
\newcommand{\rmcomment}[1]{{\color{purple}{\{RM: #1\}}}}
\newcommand{\me}[1]{{\color{green}{\{#1\}}}}

% \newcommand{\onecomment}[1]{{\color{blue}{\{R1: #1\}}}}
% \newcommand{\twocomment}[1]{{\color{red}{\{R2: #1\}}}}
% \newcommand{\kcomment}[1]{{\color{red}{KR: #1}}}
% \newcommand{\rmcomment}[1]{{\color{blue}{RM: #1}}}

% \newcommand{\me}[1]{{\color\end{answers}{violet}{\{#1\}}}}
% \newcommand{\me}[1]{{\color{violet}{\{#1\}}}}
