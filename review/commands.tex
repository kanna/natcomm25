...
\newcommand{\onecomment}[1]{{\color{red}{\{R1: #1\}}}}
\newcommand{\twocomment}[1]{{\color{blue}{\{R2: #1\}}}}
...
\def\ent{{\texttt{ENTiCE\ }}}
\def\ente{{\texttt{ENTiCE}}}
\def\rx{{\texttt{T-REX\ }}}
\def\rxe{{\texttt{T-REX}}}
\def\du{{\texttt{DUNE}\ }}
\def\due{{\texttt{DUNE}}}
...
\def\imc{{\texttt{IMC}\ }}
\def\imce{{\texttt{IMC}}}
\def\sin{{\texttt{SINMOD}\ }}
\def\sine{{\texttt{SINMOD}}}
