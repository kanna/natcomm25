...
reducing forecast errors (i.e., higher value of information). Vehicles are then directed to sample these
...
data acquistion, models and observations; model prediction generates a forecast and
associated uncertainty field while AUV based adaptive sampling target
