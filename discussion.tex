...
presence of subgrid-scale dynamics. Such unresolved variability is a
well-known source of error in data assimilation systems; numerical
...
\begin{figure}[!]
  \centering
  \includegraphics[scale=0.06]{fig/fig3D-inset.jpg}
