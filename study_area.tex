...
\begin{figure}[!t]
  ...
  and its environment.]{\label{fig:domain}\includegraphics[scale=0.195]{fig/area_ripples.png}}
  \caption{\subref{fig:po-map} \& \subref{fig:domain} show detailed
    views of the study area for \proj off the coast of mainland
    Portugal; the white bands show commercial shipping lanes. The two observing systems displayed integrate the MONIZEE real-time monitoring infrastructure operated by \textit{Instituto Hidrográfico}. The \naz
    Canyon is a significant feature of this area and a driver for the
    bio-geophysics of the domain \cite{tyler2009europe}.}
...
for spatial high-resolution numerical models capable of rapidly generating
uncertainty predictions, robust algorithms for exploration under a
...
intermittent connectivity, unpredictable weather, and vessel traffic, especially due to fishers — that further
...
model prediction by lowering costs, providing access to a range of
stakeholders, by integrating methods in low-cost computation of
modeling services coupled with spatio-temporal data assimilation from
mobile or immobile robots across space, aerial, surface and underwater
domains \cite{rajan21}.
