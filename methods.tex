...
the work approach.\kcom{But what do we loose in turn? Resolution? Need
  to state that.}
...
moving temporal window of fourteen previous \krcom{why 14? Where did
  this specific number come from?}  days as conditioning data (i.e.,
experimental data) to predict the subsequent day. This sliding-window
strategy strikes a balance between forecast skill and computational
feasibility, and can be adapted according to the complexity of the
