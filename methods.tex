...
\subsubsection{Multi-solution framework}
...
case solutions labeled \textbf{'A'} through \textbf{'D'} contribute to
the final solution set. These largely reflect the impacts of operating
in the harsh domain of the coastal environment.
