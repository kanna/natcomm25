...
significant areas of the world\rone{’s} oceans, benefiting from
...
sampling \cite{BinZhang07,Singh09,fossum19} represents a fundamental
...
model predictions with adaptive sampling with propelled AUVs. \rone{
  ...
  targeted temperature gradients; moreover the novelty of our work is
  ...
  task which could be moved onboard in the future. Our model setup is
  also simpler with CMEMS seeding the stochastic model augmenting the
  need to show this \emph{sample-assimilate-predict-direct} loop in a
  cost effective manner relying on small boats, the use of multiple
  AUVs while relying on our mature technology suite for
...
strategies which lie at the core of this paper. \rtwo{Section
  \ref{sec:results} hightlights the results of our experiment, while
