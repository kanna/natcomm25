...
Our methodology is based on implementing a data cycle to improve predictions from coastal ocean models through robotic adaptive sampling and data assimilation. The approach consists of three fundamental steps, executed iteratively on a daily basis:
...
focused on deployment based on $M_{\sigma_{\hat{\theta}}}(x, y)$. Here, loop
closure refers to the \emph{sample-assimilate-predict-direct} process.
